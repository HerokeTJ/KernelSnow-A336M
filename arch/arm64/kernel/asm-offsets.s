...
// %bb.0:
	...
	.ascii	"->VCPU_FAULT_DISR 2224 offsetof(struct kvm_vcpu, arch.fault.disr_el1)"
	//NO_APP
	//APP

	.ascii	"->VCPU_WORKAROUND_FLAGS 2232 offsetof(struct kvm_vcpu, arch.workaround_flags)"
	//NO_APP
	//APP

	.ascii	"->VCPU_HCR_EL2 2184 offsetof(struct kvm_vcpu, arch.hcr_el2)"
	//NO_APP
	//APP
