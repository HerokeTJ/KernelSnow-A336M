...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=aarch64-linux-gnu- --gcc-toolchain=/ -fintegrated-as -Werror=unknown-warning-option"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
...
ifneq "$(PLATFORM_VERSION_FOR_GPU)" "14"
include/config/auto.conf: FORCE
endif
