...
__used __section("__versions") = {
	...
	{ 0xf91506f6, "sensor_cis_set_initial_exposure" },
...
MODULE_ALIAS("of:N*T*Csamsung,exynos-is-cis-gc5035");
MODULE_ALIAS("of:N*T*Csamsung,exynos-is-cis-gc5035C*");
MODULE_ALIAS("of:N*T*Csamsung,exynos-is-cis-gc5035-macro");
MODULE_ALIAS("of:N*T*Csamsung,exynos-is-cis-gc5035-macroC*");
