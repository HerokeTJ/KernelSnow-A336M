...
ksymdeps_drivers/media/v4l2-core/v4l2-device.o := \
    $(wildcard include/ksym/v4l2/device/register/subdev/nodes.h) \
    $(wildcard include/ksym/v4l2/device/disconnect.h) \
    $(wildcard include/ksym/v4l2/device/put.h) \
    $(wildcard include/ksym/v4l2/device/register.h) \
    $(wildcard include/ksym/v4l2/device/register/subdev.h) \
    $(wildcard include/ksym/v4l2/device/set/name.h) \
    $(wildcard include/ksym/v4l2/device/unregister.h) \
    $(wildcard include/ksym/v4l2/device/unregister/subdev.h) \

drivers/media/v4l2-core/v4l2-device.o: $(ksymdeps_drivers/media/v4l2-core/v4l2-device.o)
