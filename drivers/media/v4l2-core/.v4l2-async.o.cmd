...
ksymdeps_drivers/media/v4l2-core/v4l2-async.o := \
    $(wildcard include/ksym/v4l2/async/notifier/add/devname/subdev.h) \
    $(wildcard include/ksym/v4l2/async/notifier/add/fwnode/remote/subdev.h) \
    $(wildcard include/ksym/v4l2/async/notifier/add/fwnode/subdev.h) \
    $(wildcard include/ksym/v4l2/async/notifier/add/i2c/subdev.h) \
    $(wildcard include/ksym/v4l2/async/notifier/add/subdev.h) \
    $(wildcard include/ksym/v4l2/async/notifier/cleanup.h) \
    $(wildcard include/ksym/v4l2/async/notifier/init.h) \
    $(wildcard include/ksym/v4l2/async/notifier/register.h) \
    $(wildcard include/ksym/v4l2/async/notifier/unregister.h) \
    $(wildcard include/ksym/v4l2/async/register/subdev.h) \
    $(wildcard include/ksym/v4l2/async/subdev/notifier/register.h) \
    $(wildcard include/ksym/v4l2/async/unregister/subdev.h) \

drivers/media/v4l2-core/v4l2-async.o: $(ksymdeps_drivers/media/v4l2-core/v4l2-async.o)
