...
MODULE_ALIAS("of:N*T*Csamsung,mipi-phy-m4m4-top");
MODULE_ALIAS("of:N*T*Csamsung,mipi-phy-m4m4-topC*");
MODULE_ALIAS("of:N*T*Csamsung,mipi-phy-m4m4-mod");
MODULE_ALIAS("of:N*T*Csamsung,mipi-phy-m4m4-modC*");
